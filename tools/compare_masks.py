...
def compare_directories(golden_dir, target_dir, min_bbox_iou=0.90, min_mask_iou=0.85):
...
if __name__ == "__main__":
    ...
    success = compare_directories(args.golden_dir, args.target_dir, args.min_bbox_iou, args.min_mask_iou)
